...
export const Controls = memo(function Controls({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <IconButton onClick={onRegenerate} aria-label="New graph">
        <svg viewBox="0 0 24 24" width={18} height={18} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2v3m0 14v3M2 12h3m14 0h3m-3.5-6.5-2.1 2.1M8.1 15.9 6 18m0-12 2.1 2.1M15.9 15.9 18 18"/></svg>
      </IconButton>
    </div>
  );
});
